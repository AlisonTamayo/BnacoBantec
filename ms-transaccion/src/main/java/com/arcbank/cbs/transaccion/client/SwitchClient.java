...
@FeignClient(name = "digiconecu-switch", url = "${app.switch.network-url:http://3.140.230.212:8000}", configuration = {com.arcbank.cbs.transaccion.config.MTLSConfig.class, com.arcbank.cbs.transaccion.config.SwitchFeignDecoderConfig.class})
